...
// Overhead: ADC poll (~3000) + trigger/read/store (~40) + checks (~10) = ~3050
// Remaining for delay: 4167 - 3050 = 1117 cycles
// Inline asm loop: 2 cycles per iteration (SUB + QBNE)
// Loop count: 1117 / 2 = 558
#define SAMPLE_DELAY_CYCLES 558
